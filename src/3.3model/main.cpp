...
int main()
{
    ...
    //shader文件
    Shader ourShader("./src/3.3model/ourShader.vs", "./src/3.3model/ourShader.fs");//
    Shader lightShader("./src/3.3model/light.vs","./src/3.3model/light.fs");
    //开启z缓冲
    ...
    float light_diff=1.0f;
    float light_spec=1.0f;
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        ImGui::NewFrame();
        ImGui::Begin("imgui");
        ImGui::SliderFloat("diffuse",&light_diff,0.0f,1.0f);
        ImGui::SliderFloat("specular",&light_spec,0.0f,1.0f);
       ...
       //清空屏幕和z缓冲和模板缓冲
        ...
        ourShader.setVec3("light.ambient", glm::vec3(clear_color.x,clear_color.y,clear_color.z));
        ourShader.setFloat("light.diffuse", light_diff);
        ourShader.setFloat("light.specular", light_spec);
        ourShader.setFloat("light.constant", 1.0f);
        ourShader.setFloat("light.linear", 0.09f);
        ourShader.setFloat("light.quadratic", 0.032f);
        ourShader.setVec3("light.color",glm::vec3(light_color.x,light_color.y,light_color.z));
        ourShader.setVec3("viewPos",camera.Position);

        ourModel.Draw(ourShader);
        lightShader.use();
        lightShader.setVec3("color",glm::vec3(light_color.x,light_color.y,light_color.z));
